...
\clearpage
\addcontentsline{toc}{section}{B\quad Übersicht Wirkung Normalisierungsmethoden}
\refstepcounter{chapter}
\chaptermark{Übersicht Wirkung Normalisierungmethoden}
\label{app:norm}
\section*{B\quad Übersicht Wirkung Normalisierungmethoden}
\renewcommand{\mywidth}{0.17}
\begin{figure}[h!]
\center
...
\clearpage
\addcontentsline{toc}{section}{C\quad Anpassung Übersichtsbilder}
\refstepcounter{chapter}
\chaptermark{Anpassung Übersichtsbilder}
\label{app:big}
\section*{C\quad Anpassung Übersichtsbilder}
