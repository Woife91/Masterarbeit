...
\begin{table}[h!]
\center
\caption{Zusammensetzung der Referenzsets}
\begin{tabular}{|c|r|}
\hline
...
\clearpage
\addcontentsline{toc}{section}{B\quad Übersicht über die Wirkung von verschiedenen Normalisierungsmethoden}
\refstepcounter{chapter}
\chaptermark{Übersicht über die Wirkung von verschiedenen Normalisierungmethoden}
\label{app:norm}
\section*{\raggedright B\quad Übersicht über die Wirkung von verschiedenen \mbox{\quad\phantom{B}Normalisierungsmethoden}}
\renewcommand{\mywidth}{0.17}
\begin{figure}[h!]
\center
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/01_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/02_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/03_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/04_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/05_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/06_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/07_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/08_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/09_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/10_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/11_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/12_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/13_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/14_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/15_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/16_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/17_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/18_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/19_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/20_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/21_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/22_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/23_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/24_or}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/25_or}}
...
\begin{figure}[h!]
\center
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/01_gie}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/02_gie}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/03_gie}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/04_gie}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/05_gie}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/06_gie}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/07_gie}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/08_gie}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/09_gie}}
\quad
\subfloat{\includegraphics[width = \mywidth\textwidth]{pics/Anhang/B/10_gie}}
\quad
...
\caption[B-Spline nach Color Deconvolution mit Stainvektoren der Giemsa-Färbung]{B-Spline nach Color Deconvolution mit Stainvektoren der Giemsa-Färbung, Referenzset 5 (siehe Anhang \ref{app:reference})\label{fig:25_gie}}
...
\caption{Skalierung auf ein festes Pseudomaximum \label{fig:25_fix}}
...
\clearpage
\addcontentsline{toc}{section}{C\quad Anpassung von Übersichtsbildern}
\refstepcounter{chapter}
\chaptermark{Anpassung Übersichtsbilder}
\label{app:big}
\section*{C\quad Anpassung von Übersichtsbildern}
...
\caption[Übersichtbilder Original]{Unveränderte Übersichtsbilder mit Größe 2452$\times$2056 Pixel}
\end{figure}
...
\caption[Übersichtbilder normalisiert]{Die Abbildung zeigt mittels B-Splines normalisierte Übersichtsbilder der Größe 2452$\times$2056 Pixel}
\end{figure}
