...
\quad
\caption[Identifizierung Zellzentren]{Im Korrekturschritt werden Zentren mit geringer Distanz, grün markiert in \textbf{(a)}, zu einem Zentrum zusammengefügt \textbf{(b)}. \label{fig:cell_centers}}
\end{figure} 
