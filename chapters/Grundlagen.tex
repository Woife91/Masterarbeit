...
\quad
\caption[Beispiele B-Splines]{Unterschiedliche B-Splines, abhängig von Grad und Verteilung auf Knotenvektor. Die Farbe des Bspline Teilstücks verweist auf das entsprechende Teilintervall auf dem Knotenvektor \cite{gm2014}. \label{fig:bsplines_example}}
\end{figure}
