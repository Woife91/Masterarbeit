...
Die Berechnung eines B-Splines $F$ mit Grad $n$, Kontrollpunkten $\mathbf{D} = \lbrace \mathbf{d}_0, \ldots \mathbf{d}_{m-1}$ und einem Knotenvektor $\mathbf{T}$ erfolgt nach Formel \ref{equ:bspline}\cite{gm2014}.
...
\quad
\caption[Beispiele B-Splines]{Unterschiedliche B-Splines, abhängig von Grad und Verteilung auf Knotenvektor. Die Farbe des B-Spline Teilstücks verweist auf das entsprechende Teilintervall auf dem Knotenvektor \cite{gm2014}. \label{fig:bsplines_example}}
\end{figure}
