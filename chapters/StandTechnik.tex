...
Eine Annahme die gerne gemacht wird um diese Faktoren zu finden, ist die sogenannte "Grey World Assumption". Es wird dabei davon ausgegangen dass das reflektierte Licht in einem Bild sich zu grau addiert, wobei es Variationen gibt es u.a. bei der Wahl von Grau. 
Im einfachsten Fall können die Skalierungsfaktoren entsprechend \ref{equ:grey_world} berechnet werden. Hierbei entspricht $m_{L1}$ dem Mittelwert des L-Kanals einer Referenzaufnahme, $m_{L2}$ dem Mittelwert des L-Kanals aus einer Testaufnahme, usw.  
