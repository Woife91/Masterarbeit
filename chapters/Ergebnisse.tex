...
Für die Klassifikation wurden zehn verschiedene Experimente durchgeführt, welche in Tabelle \ref{tab:ex_zuordnung} erläutert sind. Der Ansatz nach Reinhard wurde nicht weiter verfolgt, da die Farbinformationen bei diesem Ansatz extrem verfälscht werden. Die Experimente 1-4 verwenden B-Splines nach Color Deconvolution und Stainvektoren nach Landini. Unterschieden wird dabei nach verwendeter Referenz. Experiment 1 repräsentiert dabei das in Kombination von ganzer Zelle und Zellkern beste Segmentierungsresultat. In Experiment 5 wurde für Daten ohne vorherige Anpassung und mit automatischer Segmentierung getestet. In den Experimenten 6-8 beinhalten die restlichen implementierten Anpassungsmethoden B-Spline und Stainvektoren nach Macenko, Mittelwert und Standardabweichung und Fixes Maximum. Experiment 9 verwendet die Originalbilder und die manuelle Handsegmentierung, Experiment 10 ebenfalls die Originalbilder jedoch mit der automatischen Segmentierung der Daten aus Experiment 1.
