...
\hline
	Referenz(-set) & \multicolumn{2}{c|}{Gesamte Zelle}  &\multicolumn{2}{c|}{Zellkern} & \multicolumn
	{2}{c|}{Kombination}\\ \hline
	& \multicolumn{1}{c|}{Grad 8} & \multicolumn{1}{c|}{Grad 9} & \multicolumn{1}{c|}{Grad 8} & \multicolumn{1}{c|}{Grad 9} & \multicolumn{1}{c|}{\textbf{Grad 8}} & \multicolumn{1}{c|}{Grad 9} \\ \hline
	...
	\textbf{Mean Set 5} & 6 & 11 & 4 & 6 & \cellcolor{green}\textbf{1} & 7 \\ \hline
...
%TODO Beispiele für alle Zellklassen  
\begin{figure}[h]
\center
...
\includegraphics[width = 1\textwidth]{pics/Ergebnisse/normalisierungsmethoden_zelle_ganz}}
\quad
\subfloat[Fokus Boxen, ganze Zelle]{
\includegraphics[width = \textwidth]{pics/Ergebnisse/normalisierungsmethoden_zelle_zoom}}
\quad
\subfloat[Komplette Übersicht, Zellkern]{
\includegraphics[width = \textwidth]{pics/Ergebnisse/normalisierungsmethoden_kern_ganz}}
\quad
\subfloat[Fokus Boxen, Zellkern]{
\includegraphics[width = \textwidth]{pics/Ergebnisse/normalisierungsmethoden_kern_zoom}}
\caption[Vergleich Segmentierung unterschiedlicher Normalisierungsmethoden]{Die Abbildung zeigt Boxplots der Segmentierungsergebnisse für verschiedene Ansätze. Für jeden Ansatz sind die erfolgreichsten Parameterkombinationen gezeigt. \textbf{(a)} Ganze Zelle, Gesamtübersicht \textbf{(b)} Ganze Zelle, Fokus auf Boxen, \textbf{(c)} Zellkern, Gesamtübersicht \textbf{(d)} Zellkern, Fokus auf Boxen}
\end{figure}

\begin{figure}[h]
\center
\subfloat[Komplette Übersicht, ganze Zelle]{
\includegraphics[width = 0.47\textwidth]{pics/Ergebnisse/diff_methoden_zelle_ganz}}
\quad
\subfloat[Fokus Boxen, ganze Zelle]{
\includegraphics[width = 0.47\textwidth]{pics/Ergebnisse/diff_methoden_zelle_zoom}}
\quad
\subfloat[Komplette Übersicht, Zellkern]{
\includegraphics[width = 0.47\textwidth]{pics/Ergebnisse/diff_methoden_kern_ganz}}
\quad
\subfloat[Fokus Boxen, Zellkern]{
\includegraphics[width = 0.47\textwidth]{pics/Ergebnisse/diff_methoden_kern_zoom}}
